        ...
        <main>
            ...
            <h1 class="mt-4">Staff List</h1>
                ...
                <div class="card mb-4">
                    ...
                    <form method="GET" action="staff-list.php" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                    <?Php
                        $sql = "SELECT u.*, r.rolename FROM user u JOIN role r ON u.role_id = r.role_id WHERE u.role_id = 3"; 
                            //filtering listing
