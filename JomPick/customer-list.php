    ...
    <div id="layoutSidenav_content">
        ...
        <main>
            ...
            <h1 class="mt-4">Customer List</h1>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-md-6">
                                    <div class="form-group">
                                            <label for="userid">JomPick ID:</label><br/>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="form-group">
                                            <label for="client">Client Type:</label><br/>
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div><i class="fas fa-table me-1"></i> Customer List</div>
                        <div class="small text-white"><a href="staff_register.php" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Register</a></div>
                    </div>
                    <div class="card-body">
                    <?Php
                    $sql = "SELECT u.*, r.rolename FROM user u JOIN role r ON u.role_id = r.role_id WHERE u.role_id IN (4, 5, 6)"; 
                            //filtering listing
                            ...
                            if($client!=""){
                                ...
                                $sql = "SELECT u.*, r.rolename FROM user u JOIN role r ON u.role_id = r.role_id WHERE u.role_id IN (4, 5, 6)  ORDER BY userName asc"; 
                                $result = mysqli_query($conn, $sql);
                                //print $sql;
                            }
