...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_FILES["image"]) && $_FILES["image"]["error"] == UPLOAD_ERR_OK) {
        ...
        if ($stmt->execute()) {
            ...
            $sql4 = "INSERT INTO confirmation (jp_confirmation_id, currentLocation, pickUpLocation_id, confirmationStatus) VALUES ('$jp_confirmation_id','-', $location,3);";
            ...
            $sql4 = "INSERT INTO item_management (userManager_id, item_id, dueDate_id, confirmation_id, resit_id, JomPick_ID, registerDate,	ready_id, availability_id)
                        VALUES (
                            $user_id,
            ...
            header("Location: ../jompick-register.php");
            exit();
        } else {
